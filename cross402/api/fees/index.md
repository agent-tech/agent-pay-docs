...
> Fee rows reflect the chains your deployment exposes via `GET /api/chains`. See [Supported Chains](../../../introduction/supported-networks/) for the live set and per-chain caveats.
