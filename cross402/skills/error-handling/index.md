...
| `402` | Payment required — agent wallet has insufficient stablecoin balance for `ExecuteIntent` | No | Top up the agent wallet |
...
* [API Documentation: Error Codes](../../error-codes/)
