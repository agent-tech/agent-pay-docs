...
See [Error Handling](../error-handling/) for detailed error information.
...
| --- | --- | --- | --- |
| 400 | ValidationError | Invalid amount (out of range) | Ensure amount is between 0.02 and 1,000,000 USD |
...
> For comprehensive error handling patterns and retry strategies, see [Error Handling](../error-handling/).
...
3. **Chain Support**: See [Supported Chains](../../../introduction/supported-networks/) for the full payer × target matrix.
4. **Settlement**: The merchant receives the stablecoin on `target_chain`. Defaults to `base` if omitted. For the mechanics, see [Multi-Chain Settlement](../../concepts/multi-chain-settlement/).
