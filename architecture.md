...
AgentPay acts as a bridge between multiple source chains and the Base settlement layer.
...
3. **Verification**: AgentPay monitors the source chain for transaction finality.
4. **Settlement**: Once verified, AgentPay executes the final transfer on the **Base chain** to the merchant's wallet.
